define(function(require, exports, module) {
        ...
        if(len > 0){
            for(var i=0, l=len; i<l; i++){
                ...
                if(typeof ret === 'object' && typeof ret.text !=='undefined'){
                    ...
                    //回调方法
                    btns[i].handler = (typeof btns[i].handler !== 'undefined' && btns[i].handler === 'close') ?function(){ _ts.remove(); } : btns[i].handler;
    ...
    pop.prototype.render = function(){
        var _ts = this,
            ...
            closeEl = opts.isClose ? '<span class="pm_close">关闭</span>' : '',
    ...
    pop.prototype.modChoose = function(ret){
        ...
        var _ts = this,
            data = ret.data, //格式：[['key', 'name', 'href'], ['1086', '地下城与勇士', 'http://dnf.aipai.com/']]
            cur = ret.cur ? ret.cur : -1,
            type = ret.type ? ret.type : 'common';
